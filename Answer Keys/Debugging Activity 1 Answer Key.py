...
won't run! Can you help me fix it?
'''
...
def main():
    ...
    fav_color = input("Hi " + username + ", what is your favorite color: ")

    if fav_color.lower() == "red":
        print("Hey, that's my favorite color too!")
    elif fav_color.lower() == "gray":
        print("Ugh, that's my least favorite color!")
    else:
        print("Nice color!")
